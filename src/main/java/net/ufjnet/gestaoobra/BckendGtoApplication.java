...
public class BckendGtoApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		User u1 = new User();
		u1.setUsername("jhonata_admin");
		u1.setFullName("Jhonata Kumaki");
		u1.setPassword(r1);
		...
		User u2 = new User();
		u2.setUsername("jhonata_user");
		u2.setFullName("Jhonata Rodrigues");
		u2.setPassword(r2);
		...
		pm2.getUsers().addAll(Arrays.asList(u1, u2));
