...
@Tag(name = "Endpoint de lancamentos") 
public class LancamentoController {
	...
	@GetMapping
	@Operation(summary = "Busca todos os lancamentos")
	...
	@GetMapping("/{id}")
	@Operation(summary = "Busca um lancamento por id")
	...
	@Operation(summary = "Insere um novo lancamento")
	...
	public ResponseEntity<LancamentoDTO> atualizar(@PathVariable Integer id, @RequestBody LancamentoDTO objBody) {
		LancamentoDTO objDTO = service.save(objBody);
		objDTO.add(linkTo(methodOn(LancamentoController.class).buscarUm(objDTO.getCodigo())).withSelfRel());
		return ResponseEntity.ok(objDTO);
	}		
	...
	@DeleteMapping("/{id}")
	@Operation(summary = "Exclui um lancamento por id")
